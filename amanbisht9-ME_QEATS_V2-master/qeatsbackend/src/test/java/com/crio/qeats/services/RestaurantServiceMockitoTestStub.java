...
public class RestaurantServiceMockitoTestStub {
  ...
  public void initializeRestaurantObjects() throws IOException {
    String fixture =
       ...
       Restaurant[] restaurants = objectMapper.readValue(fixture, Restaurant[].class);
        ...
        restaurant1 = (Restaurant) Array.get(restaurants,0);
        restaurant2 = (Restaurant) Array.get(restaurants,1);
        restaurant3 = (Restaurant) Array.get(restaurants,2);
        restaurant4 = (Restaurant) Array.get(restaurants,3);
        restaurant5 = (Restaurant) Array.get(restaurants,4);        
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    GetRestaurantsResponse allRestaurantsCloseByOffPeakHours = restaurantService.findAllRestaurantsCloseBy(new GetRestaurantsRequest(21.0,31.1), LocalTime.of(19, 0));
    GetRestaurantsResponse allRestaurantsCloseByPeakHours = (restaurantService.findAllRestaurantsCloseBy(new GetRestaurantsRequest(20.0,30.2), LocalTime.of(3, 0)));
    ...
    assertEquals("12", allRestaurantsCloseByOffPeakHours.getRestaurants().get(0).getRestaurantId());
